...
<section class="intro-grid">
  ...
  <div>
    <p class="large-copy">My work begins where the clean diagram ends: inconsistent records, shifting requirements, overloaded teams, and systems that still need to produce trustworthy answers.</p>
    <p>I combine analysis, administration, documentation, and automation to make those environments more reliable. The same discipline continues inside my independent lab through embedded systems, radio, wireless networking, defensive research, and field computing.</p>
  </div>
</section>
...
<section class="work-section">
  ...
  <div class="work-grid">
    ...
    <a class="work-card green" href="/projects/#wilmington-mesh">
      ...
      <p>A living field record of node maintenance, hardware evaluation, antenna choices, configuration, and community mesh planning.</p>
      <small>FIELDWORK / LORA / DOCUMENTATION</small>
    </a>
    <a class="work-card bone" href="/projects/#applied-lab">
      <span>Applied research</span>
      <h3>Devious Designs Applied Technology Lab</h3>
      <p>Firsthand hardware research preserved as experiments, repairs, prototypes, measurements, and failed attempts worth remembering.</p>
      <small>HARDWARE / SIGNALS / PROTOTYPING</small>
    </a>
  </div>
</section>
